  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="90px">
      ...
      <el-form-item prop="moduleId" label="所属模块"
        ><el-input v-model="form.moduleId" placeholder="模块 ID"
      /></el-form-item>
...
function onOpen() {
  ...
  form.name = d?.name ?? "";
  form.moduleId = d?.moduleId ?? "m-1-1";
  form.level = d?.level ?? "P1";
  form.precondition = d?.precondition ?? "";
  form.steps = d?.steps?.length ? [...d.steps] : [];
