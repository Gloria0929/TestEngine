      ...
      <el-menu>
        ...
        >
          <span class="report-item">
            <el-tag :type="statusTag(r.status)" size="small">{{
              statusText(r.status)
            }}</el-tag>
          ...
          <template #default="{ row }">
            <div class="expand">
              <div class="expand-row">
                <span class="expand-label">断言</span
                ><span>{{ row.assertion || "-" }}</span>
              </div>
              <div class="expand-row">
                <span class="expand-label">提取</span
                ><span>{{ row.extract || "-" }}</span>
              </div>
              <div class="expand-row">
                <span class="expand-label">控制台</span>
                <div class="console-lines">
                  <div v-if="!(row.console && row.console.length)">-</div>
                  <div
                    v-for="(line, i) in row.console"
                    :key="i"
                    class="console-line"
                  >
                    {{ line }}
