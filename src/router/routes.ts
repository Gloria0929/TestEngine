  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "ProjectMessage",
        component: () => import("@/views/project/message/index.vue"),
        meta: { permission: "project:view" },
      },
      {
        path: "project/log",
      ...
      {
        path: "setting/system/org",
        name: "SysOrg",
        component: () => import("@/views/setting/system/org/index.vue"),
        meta: { permission: "system:view" },
      },
      {
        path: "setting/system/param",
        name: "SysParam",
        component: () => import("@/views/setting/system/param/index.vue"),
        meta: { permission: "system:view" },
      },
      {
        path: "setting/system/plugin",
        name: "SysPlugin",
        component: () => import("@/views/setting/system/plugin/index.vue"),
        meta: { permission: "system:view" },
      },
      {
        path: "setting/org/member",
        name: "OrgMember",
        component: () => import("@/views/setting/org/member/index.vue"),
        meta: { permission: "system:view" },
      },
      {
        path: "setting/org/userGroup",
        name: "OrgUserGroup",
        component: () => import("@/views/setting/org/userGroup/index.vue"),
        meta: { permission: "system:view" },
      },
      {
        path: "setting/org/integration",
        name: "OrgIntegration",
        component: () => import("@/views/setting/org/integration/index.vue"),
        meta: { permission: "system:view" },
      },
      {
        path: "setting/org/project",
        name: "OrgProject",
      ...
      {
        path: "personal/recycle",
        name: "PersonalRecycle",
        component: () => import("@/views/personal/recycle/index.vue"),
      },
    ],
  },
  {
