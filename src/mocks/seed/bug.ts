...
export function createBugs(): Bug[] {
  return [
    { id: 'b-1', projectId: 'p-1', planId: 'tp-1', title: '登录页在 Safari 下样式错乱', severity: 'MAJOR', status: 'ASSIGNED', assignee: 'dev', reporter: 'test', description: 'Safari 14 下 flex 布局异常', createTime: '2026-08-26 10:00', moduleId: 'm-1-1', folderId: 'bug-f1' },
